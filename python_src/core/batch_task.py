...
class BatchTask(object, metaclass=ABCMeta):
    """Base class for Tasks that process batches of data."""
    ...
    @abstractmethod
    def run(self, engine: Engine, context: Batch) -> DataBundle:
    ...
    def relevancy_filters(self) -> list[str]:
        """Returns a list of definitions for filtering relevant content via MultiSelect questions."""
